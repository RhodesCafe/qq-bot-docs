...
:::tip
本文是[提问的智慧](https://github.com/ryanhanwu/How-To-Ask-Questions-The-Smart-Way/blob/main/README-zh_CN.md)的国内镜像版本，有任何疑问请直接向原仓库提交  
对些许链接做了处理，因此可能和原文稍有差异
:::
...
在黑客 (http://www.catb.org/~esr/faqs/hacker-howto.html)的世界里，当你拋出一个技术问题时，最终是否能得到有用的回答，往往取决于你所提问和追问的方式。本指南将教你如何正确的提问以获得你满意的答案。
...
（欢迎对本指南提出改进意见。你可以把你的建议发送至 esr@thyrsus.comesr 或 respond-auto@linuxmafia.com。然而请注意，本文并非网络礼节 (http://www.ietf.org/rfc/rfc1855.txt)的通用指南，而我们通常会拒绝无助于在技术论坛得到有用答案的建议）。
...
Stack Exchange 已经成长到超过一百个网站 (https://stackexchange.com/sites)，以下是最常用的几个站：
...
当你发布软件或补丁时，试着按软件发布实践 (http://en.tldp.org/HOWTO/Software-Release-Practice-HOWTO/index.html)操作。
